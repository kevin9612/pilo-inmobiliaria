...
class ApartamentosTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Direccion', 'Descripcion', 'IdTipo', 'Precio', 'Latitud', 'Longitud', ),
        self::TYPE_CAMELNAME     => array('id', 'direccion', 'descripcion', 'idTipo', 'precio', 'latitud', 'longitud', ),
        self::TYPE_COLNAME       => array(ApartamentosTableMap::COL_ID, ApartamentosTableMap::COL_DIRECCION, ApartamentosTableMap::COL_DESCRIPCION, ApartamentosTableMap::COL_ID_TIPO, ApartamentosTableMap::COL_PRECIO, ApartamentosTableMap::COL_LATITUD, ApartamentosTableMap::COL_LONGITUD, ),
        self::TYPE_FIELDNAME     => array('id', 'direccion', 'descripcion', 'id_tipo', 'precio', 'latitud', 'longitud', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Direccion' => 1, 'Descripcion' => 2, 'IdTipo' => 3, 'Precio' => 4, 'Latitud' => 5, 'Longitud' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'direccion' => 1, 'descripcion' => 2, 'idTipo' => 3, 'precio' => 4, 'latitud' => 5, 'longitud' => 6, ),
        self::TYPE_COLNAME       => array(ApartamentosTableMap::COL_ID => 0, ApartamentosTableMap::COL_DIRECCION => 1, ApartamentosTableMap::COL_DESCRIPCION => 2, ApartamentosTableMap::COL_ID_TIPO => 3, ApartamentosTableMap::COL_PRECIO => 4, ApartamentosTableMap::COL_LATITUD => 5, ApartamentosTableMap::COL_LONGITUD => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'direccion' => 1, 'descripcion' => 2, 'id_tipo' => 3, 'precio' => 4, 'latitud' => 5, 'longitud' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('latitud', 'Latitud', 'DOUBLE', true, null, null);
        $this->addColumn('longitud', 'Longitud', 'DOUBLE', true, null, null);
    } // initialize()
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Comentarios', '\\Comentarios', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':id_apartamento',
    1 => ':id',
  ),
), null, null, 'Comentarioss', false);
    } // buildRelations()
