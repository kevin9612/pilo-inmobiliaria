...
class UsuariosTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Login', 'Password', 'Tipo', ),
        self::TYPE_CAMELNAME     => array('id', 'login', 'password', 'tipo', ),
        self::TYPE_COLNAME       => array(UsuariosTableMap::COL_ID, UsuariosTableMap::COL_LOGIN, UsuariosTableMap::COL_PASSWORD, UsuariosTableMap::COL_TIPO, ),
        self::TYPE_FIELDNAME     => array('id', 'login', 'password', 'tipo', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Login' => 1, 'Password' => 2, 'Tipo' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'login' => 1, 'password' => 2, 'tipo' => 3, ),
        self::TYPE_COLNAME       => array(UsuariosTableMap::COL_ID => 0, UsuariosTableMap::COL_LOGIN => 1, UsuariosTableMap::COL_PASSWORD => 2, UsuariosTableMap::COL_TIPO => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'login' => 1, 'password' => 2, 'tipo' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    {
        $this->addRelation('Personas', '\\Personas', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':id_usuario',
    1 => ':id',
  ),
), null, null, 'Personass', false);
    } // buildRelations()
