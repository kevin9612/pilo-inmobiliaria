...
abstract class Personas implements ActiveRecordInterface
{
    ...
    /**
     * The value for the correoelectronico field.
     *
     * @var        string
     */
    ...
    /**
     * Get the [correoelectronico] column value.
     *
     * @return string
     */
    ...
    public function setNombre($v)
    {
        ...
        if ($this->nombre !== $v) {
            $this->nombre = $v;
            $this->modifiedColumns[PersonasTableMap::COL_NOMBRE] = true;
        }
    ...
    public function setApellido($v)
    {
        ...
        if ($this->apellido !== $v) {
            $this->apellido = $v;
            $this->modifiedColumns[PersonasTableMap::COL_APELLIDO] = true;
        }
    ...
    public function setIdentificacion($v)
    {
        ...
        if ($this->identificacion !== $v) {
            ...
            $this->modifiedColumns[PersonasTableMap::COL_IDENTIFICACION] = true;
        }
    ...
    /**
     * Set the value of [correoelectronico] column.
     *
     * @param string $v new value
     * @return $this|\Personas The current object (for fluent API support)
     */
    public function setCorreoelectronico($v)
    {
        ...
        if ($this->correoelectronico !== $v) {
            $this->correoelectronico = $v;
            $this->modifiedColumns[PersonasTableMap::COL_CORREOELECTRONICO] = true;
        }
    ...
    public function setIdUsuario($v)
    {
        ...
        if ($this->id_usuario !== $v) {
            $this->id_usuario = $v;
            $this->modifiedColumns[PersonasTableMap::COL_ID_USUARIO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PersonasTableMap::translateFieldName('Nombre', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nombre = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PersonasTableMap::translateFieldName('Apellido', TableMap::TYPE_PHPNAME, $indexType)];
            $this->apellido = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PersonasTableMap::translateFieldName('Identificacion', TableMap::TYPE_PHPNAME, $indexType)];
            $this->identificacion = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : PersonasTableMap::translateFieldName('Correoelectronico', TableMap::TYPE_PHPNAME, $indexType)];
            $this->correoelectronico = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : PersonasTableMap::translateFieldName('IdUsuario', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 6; // 6 = PersonasTableMap::NUM_HYDRATE_COLUMNS.
    ...
    {
        if ($this->aUsuarios !== null && $this->id_usuario !== $this->aUsuarios->getId()) {
            $this->aUsuarios = null;
        }
    } // ensureConsistency
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PersonasTableMap::COL_NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = 'nombre';
        }
        if ($this->isColumnModified(PersonasTableMap::COL_APELLIDO)) {
            $modifiedColumns[':p' . $index++]  = 'apellido';
        }
        if ($this->isColumnModified(PersonasTableMap::COL_IDENTIFICACION)) {
            $modifiedColumns[':p' . $index++]  = 'identificacion';
        }
        if ($this->isColumnModified(PersonasTableMap::COL_CORREOELECTRONICO)) {
            $modifiedColumns[':p' . $index++]  = 'correoelectronico';
        }
        if ($this->isColumnModified(PersonasTableMap::COL_ID_USUARIO)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'apellido':
                        ...
                        break;
                    case 'identificacion':
                        $stmt->bindValue($identifier, $this->identificacion, PDO::PARAM_STR);
                        break;
                    case 'correoelectronico':
                        $stmt->bindValue($identifier, $this->correoelectronico, PDO::PARAM_STR);
                        break;
                    case 'id_usuario':
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[4] => $this->getCorreoelectronico(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setIdentificacion($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setCorreoelectronico($arr[$keys[4]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PersonasTableMap::COL_NOMBRE)) {
            $criteria->add(PersonasTableMap::COL_NOMBRE, $this->nombre);
        }
        if ($this->isColumnModified(PersonasTableMap::COL_APELLIDO)) {
            $criteria->add(PersonasTableMap::COL_APELLIDO, $this->apellido);
        }
        if ($this->isColumnModified(PersonasTableMap::COL_IDENTIFICACION)) {
            $criteria->add(PersonasTableMap::COL_IDENTIFICACION, $this->identificacion);
        }
        if ($this->isColumnModified(PersonasTableMap::COL_CORREOELECTRONICO)) {
            $criteria->add(PersonasTableMap::COL_CORREOELECTRONICO, $this->correoelectronico);
        }
        if ($this->isColumnModified(PersonasTableMap::COL_ID_USUARIO)) {
            $criteria->add(PersonasTableMap::COL_ID_USUARIO, $this->id_usuario);
        }
    ...
    public function getUsuarios(ConnectionInterface $con = null)
    {
        if ($this->aUsuarios === null && ($this->id_usuario !== null)) {
            $this->aUsuarios = ChildUsuariosQuery::create()->findPk($this->id_usuario, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUsuarios->addPersonass($this);
             */
        }
    ...
    {
        if (null !== $this->aUsuarios) {
            $this->aUsuarios->removePersonas($this);
        }
        $this->id = null;
        $this->nombre = null;
        $this->apellido = null;
