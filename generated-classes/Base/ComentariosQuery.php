 ...
 * @method     ChildComentariosQuery orderByComentarios($order = Criteria::ASC) Order by the comentarios column
 *
 ...
 * @method     ChildComentariosQuery groupByComentarios() Group by the comentarios column
 *
 ...
 * @method     ChildComentarios findOneByComentarios(string $comentarios) Return the first ChildComentarios filtered by the comentarios column *
 ...
 * @method     ChildComentarios requireOneByComentarios(string $comentarios) Return the first ChildComentarios filtered by the comentarios column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildComentarios[]|ObjectCollection findByComentarios(string $comentarios) Return ChildComentarios objects filtered by the comentarios column
...
abstract class ComentariosQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id_apartamento, id, comentarios FROM comentarios WHERE id = :p0';
        try {
    ...
    public function filterByComentarios($comentarios = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ComentariosTableMap::COL_COMENTARIOS, $comentarios, $comparison);
    }

    /**
     * Filter the query by a related \Apartamentos object
     *
     * @param \Apartamentos|ObjectCollection $apartamentos The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    public function filterByApartamentos($apartamentos, $comparison = null)
    {
        if ($apartamentos instanceof \Apartamentos) {
            return $this
                ->addUsingAlias(ComentariosTableMap::COL_ID_APARTAMENTO, $apartamentos->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(ComentariosTableMap::COL_ID_APARTAMENTO, $apartamentos->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
